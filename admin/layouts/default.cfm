			...
			<div class="row-fluid">
				<div class="navbar navbar-murafw1">
					<div class="navbar-inner">
						...
						<a class="plugin-brand" href="#buildURL('admin:setting')#">#HTMLEditFormat(rc.pc.getPackage())#</a>

						<ul class="nav">
							<li class="<cfif rc.action contains 'admin:setting'>active</cfif>">
								<a href="#buildURL('admin:setting')#">Settings</a>
							</li>
						</ul><!--- /.nav --->
