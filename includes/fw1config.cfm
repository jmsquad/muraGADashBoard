...
*/
	...
	variables.framework.package = 'muraGADashboard';
	...
	variables.framework.reloadApplicationOnEveryRequest = variables.framework.debugMode;
	...
	variables.framework.defaultSection = 'setting';
	...
	variables.framework.password = 'gcappR3l0ad'; // IF you're NOT using the default reload key of 'appreload', then you'll need to update this to match the setting found in /config/settings.ini.cfm!
